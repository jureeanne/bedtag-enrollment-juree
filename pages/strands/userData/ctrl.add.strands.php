...
if (isset($_POST['submit'])) {
    ...
    $strand_name = mysqli_real_escape_string($conn, $_POST['strand']);
    ...
    if ($result == 0) {
        $insertSub = mysqli_query($conn, "INSERT INTO tbl_strand (strand_name, strand_def) VALUES ('$strand_name', '$strand_def')") or die(mysqli_error($conn));
