                ...
                <div class="row">
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-success">
                      ...
                      <a href=" <?php echo $_SESSION['role']== "Registrar" ? "list.enrolled.students.php" : ""?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                  <!-- ./col -->
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning">
                      ...
                      <a href="list.pending.students.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                  <!-- ./col -->
                  <div class="col-lg-3 col-6">
                  ...
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-danger">
                      ...
                      <a href="list.disapproved.students.php"<?php echo $_SESSION['role']== "Registrar" ? "../student/list.students.php" : "#"?> class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                  <!-- ./col -->
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-secondary">
                      ...
                      <a href=" <?php echo $_SESSION['role']== "Registrar" ? "list.online.inquiries.php" : ""?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                  <!-- ./col -->
                </div>
