...
<head>
  ...
  <title>Pending Students  | BED Taguig</title>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">List of Pending Students </h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <div class="card-body">
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody class="border-bottom">
                ...
                WHERE (remark = 'Cancelled' OR remark = 'Pending') AND ay.academic_year = '$_SESSION[active_acadyear]' AND (sem.semester = '$_SESSION[active_semester]' OR sy.semester_id = '')   
