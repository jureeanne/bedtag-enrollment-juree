...
<head>
  ...
  <title>Disapproved Students  | BED Taguig</title>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">List of Disapproved Students </h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">List of Disapproved Students </h3>
          ...
          <div class="card-body">
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody class="border-bottom">
                ...
                WHERE (remark = 'Canceled' OR remark = 'Disapproved') AND ay.academic_year = '$_SESSION[active_acadyear]' AND (sem.semester = '$_SESSION[active_semester]' OR sy.semester_id = '0')    
                ORDER BY sy.student_id DESC") or die(mysqli_error($conn));
