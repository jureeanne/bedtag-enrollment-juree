...
<head>
  ...
  <title>New Students  | BED Taguig</title>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">List of New Students </h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">List of New Students </h3>
                ...
                <?php
                 if (isset($_GET['search'])) {
                  $search = addslashes($_GET['search']);
                    ...
                    WHERE remark = 'Approved' AND stud_type = 'New' AND ay.academic_year = '$_SESSION[active_acadyear]' AND (sem.semester = '$_SESSION[active_semester]' OR sy.semester_id = '0')
